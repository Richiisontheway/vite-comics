...
<template>
    <header>
        <section class="d-flex align-items-center comix--headerContainer">
        ...
        <section class="comix--jumboContainer">
        </section>
        <section class="comix--newText d-grid ">
            <div class="container d-flex align-items-center">
                <div class="row flex-grow-1 flex-wrap ">
                    <comix 
                    v-for="(comix, i) in comixList" :key="i"
                    :img="comix.thumb"
                    :name="comix.series"
                    />
                </div>
            </div>
            <button class="comix--buttonHeader">
                Show more
            </button>
        </section>
    </header>
